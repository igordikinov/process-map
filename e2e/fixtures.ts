...
//
// ЗАЧЕМ. openScreen зовёт window.open(url, '_top'), а страница теста не в
// iframe, поэтому фолбэк на '_blank' не срабатывает и настоящий вызов уводит
// весь тест на чужой сайт: ассерты начинают гонку с живой навигацией. Именно
