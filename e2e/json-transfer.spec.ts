...
test.describe('Сбросить правки: двухшаговая кнопка', () => {
  ...
  // браузер подавляет его МОЛЧА, и сброс прошёл бы без вопроса. Это тот же
  // класс тихого отказа, из-за которого в process-map-6ap отказались от
  // _top-навигации: перехватить нечего. Поэтому вопрос —
