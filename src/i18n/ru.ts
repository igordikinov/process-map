...
export const ru = {
  ...
  toolbar: {
     ...
     *
     * Текстов ошибок импорта здесь НЕТ намеренно: утверждённого набора строк
     * для них не существует, а выдумывать формулировку запрещено
     * (CLAUDE.md «Чего не делать»). Пока их не согласует владелец процесса,
     * непринятый файл просто игнорируется — см. EditorActions.tsx.
     */
