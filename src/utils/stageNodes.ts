...
//
// Модуль живёт в `src/`: правило нужно и экрану, и раскладке, а раскладка сама
// с process-map-70e.2 переехала в `src/layout/stageLayout.ts` (её ядро вызывают
// и `npm run layout`, и импорт BPMN в браузере). Здесь — только классификация
// уже существующих узлов, без пересчёта координат.
//
